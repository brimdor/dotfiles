![dotfiles-logo](https://github.com/Brimdor/dotfiles/assets/46715299/6c1d626d-28d2-41e3-bde5-981d9bf93462)

<p align="center">
    <a href="https://github.com/Brimdor/dotfiles/actions/workflows/ansible-lint.yml"><img align="center" src="https://github.com/Brimdor/dotfiles/actions/workflows/ansible-lint.yml/badge.svg"/></a>
    <a href="https://github.com/Brimdor/dotfiles/issues"><img align="center" src="https://img.shields.io/github/issues/brimdor/dotfiles"/></a>
    <a href="https://github.com/sponsors/Brimdor"><img align="center" src="https://img.shields.io/github/sponsors/brimdor"/></a>
    ...
    <a href="https://github.com/Brimdor/dotfiles/commits/main"><img align="center" src="https://img.shields.io/github/commit-activity/m/brimdor/dotfiles" alt="commit frequency"></a>
</p>

---

Fully automated development environment for [Brimdor](https://www.twitch.tv/Brimdor) on Twitch.

You can watch a quick 'tour' (pre-1Password integration) here on YouTube:

<a href="https://youtu.be/hPPIScBt4Gw">
    <img src="https://github.com/Brimdor/dotfiles/assets/46715299/b114ea0c-b67b-437b-87d3-7c7732aeccf8" alt="Automating your Dotfiles with Ansible: A Showcase" style="width:60%;"/>
</a>
...
EXAMPLE: If `name: brimdor` is provided, it will extract the values from the `vault_path` and create the `~/.ssh/brimdor.pub` and `~/ssh/brimdor` ssh keys.

> [!NOTE]
> This variable can be called anything. Currently it is called `brimdor` just for my brain to know these are associated with my `brimdor` github user account. But if you were in multiple github orgs/users and you wanted a key associated ONLY with your account for that org/user, you would create another `op.ssh.github.some_org_user_here` and list your keys in that var, promoting organizational awareness at a glance of the config.

Example `op.ssh.github.brimdor` config:
...
> [!WARNING] > `op.system.hosts` is not implemented yet, but the information is the target implementation structure.
...
```bash
bash -c "$(curl -fsSL https://raw.githubusercontent.com/Brimdor/dotfiles/main/bin/dotfiles)"
```

If you want to run only a specific role, you can specify the following bash command:

```bash
curl -fsSL https://raw.githubusercontent.com/Brimdor/dotfiles/main/bin/dotfiles | bash -s -- --tags comma,seperated,tags
```
